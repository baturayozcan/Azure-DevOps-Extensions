...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var collectionuri, projectname, buildid, branchname, PythonShell_1, options;
        return __generator(this, function (_a) {
            try {
                collectionuri = tl.getInput('collectionuri', true);
                ...
                buildid = tl.getInput('buildid', true);
                if (buildid == 'bad') {
                    tl.setResult(tl.TaskResult.Failed, 'Bad "buildid" input was given');
                    return [2 /*return*/];
                }
                branchname = tl.getInput('branchname', true);
                if (branchname == 'bad') {
                ...
                PythonShell_1 = require('python-shell').PythonShell;
                options = {
                    mode: 'text',
                    pythonPath: 'python',
                    pythonOptions: [],
                ...
                PythonShell_1.run('tag-build.py', options, function (err, results) {
                    if (err)
                        console.log(err);
